...
if ($show_info || $show_form || $show_map) : ?>
    <section class="section"><div class="nh-container"><?php if ($show_info || $show_form) : ?><div class="nh-enquire">
        ...
        <?php if ($show_form) : ?><div class="nh-enquire__form"><?php if ($contact_form_title !== '') : ?><h2 class="nh-enquire__heading"><?php echo esc_html($contact_form_title); ?></h2><?php endif; ?><?php if ($form_html !== '') : ?><div class="nh-contact-form"><?php echo $form_html; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></div><?php endif; ?></div><?php endif; ?>
