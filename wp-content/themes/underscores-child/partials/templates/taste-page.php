...
$render_related = static function (array $selected_posts = []): void {
    $selected_posts = array_values(array_filter(array_map('absint', $selected_posts)));
    $query_args = [
        'post_type' => 'post',
        'post_status' => 'publish',
        'posts_per_page' => 3,
    ...
    if ($selected_posts !== []) {
        ...
        $query_args['category_name'] = 'phong-vi';
    }
...
if ($intro_eyebrow !== '' || $intro_title !== '' || $intro_lead !== '' || $pillars !== [] || $portraits !== []) : ?>
    <section class="section-intro"><div class="nh-container nh-stack"><div class="nh-intro"><?php if ($intro_eyebrow !== '') : ?><p class="nh-intro__eyebrow"><?php echo esc_html($intro_eyebrow); ?></p><?php endif; ?><?php if ($intro_title !== '') : ?><h2 class="nh-intro__title"><?php echo wp_kses_post($intro_title); ?></h2><?php endif; ?><?php if ($intro_lead !== '') : ?><p class="nh-intro__lead"><?php echo esc_html($intro_lead); ?></p><?php endif; ?></div>
